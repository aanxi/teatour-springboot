...
<div class="confirmPayPageDiv">
	<div class="confirmPayImageDiv">
		...
		<div class="confirmPayTime1">${order.create_date}</div>
		<div class="confirmPayTime2">${order.pay_date}</div>
		<div class="confirmPayTime3">${order.delivery_date}</div>
...
<!-- 			</tr> -->
			<tr>
				<td>收货信息：</td>
				<td>${order.address}，${order.receiver}，
					${order.mobile}，${order.post}</td>
			</tr>
			<tr>
				<td>成交时间：</td>
