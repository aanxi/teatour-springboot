	...
	<div class="reviewProductInfoDiv">
		<div class="reviewProductInfoImg">
			<img width="400px" height="400px"
				src="img/product/${product.id}/1.jpg">
		</div>
		<div class="reviewProductInfoRightDiv">
			<div class="reviewProductInfoRightText">${product.name}</div>
			<table class="reviewProductInfoTable">
				<tr>
					<td width="75px">价格:</td>
					<td><span class="reviewProductInfoTablePrice">￥${product.price}</span>
						元</td>
				</tr>
				<tr>
					<td>配送</td>
				...
				<tr>
					<td>月销量:</td>
					<td><span class="reviewProductInfoTableSellNumber">${product.sale}</span>
						件</td>
				</tr>
			</table>
			...
			<div class="reviewProductInfoRightBelowDiv">
				<span class="reviewProductInfoRightBelowImg"><img
					src="img/fore/reviewLight.png"></span> <span
					class="reviewProductInfoRightBelowText" style="margin-top: 2px;">现在查看的是
					您所购买商品的信息于${order.create_date}下单购买了此商品 </span>
			</div>
		</div>
