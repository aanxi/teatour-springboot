	...
	<div class="imgAndInfo">
		<div class="imgInimgAndInfo">
			...
			<div class="smallImageDiv">
				<img class="smallImg" src="img/product/${product.id}/1.jpg"
					bigImgURL="img/product/${product.id}/1.jpg"> <img
					class="smallImg" src="img/product/${product.id}/2.jpg"
					bigImgURL="img/product/${product.id}/2.jpg"> <img
					class="smallImg" src="img/product/${product.id}/3.jpg"
					bigImgURL="img/product/${product.id}/3.jpg"> <img
					class="smallImg" src="img/product/${product.id}/4.jpg"
					bigImgURL="img/product/${product.id}/4.jpg"> <img
					class="smallImg" src="img/product/${product.id}/5.jpg"
					bigImgURL="img/product/${product.id}/5.jpg">
		...
		<div class="infoInimgAndInfo">
			...
			<div class="productSubTitle">${product.sub_title}</div>
				...
				<div class="productPriceDiv">
					...
					<div class="promotionDiv">
						<span class="promotionPriceDesc">价格</span> <span
							class="promotionPriceYuan">¥</span> <span class="promotionPrice">${product.price}</span>
					</div>
				</div>
			</div>
			...
			<div class="productSaleAndReviewNumber">
				<div>
					销量<span class="redColor boldWord">${product.sale}</span>
				</div>
				<div>
					累计评价<span class="redColor boldWord">${product.reviewCount}</span>
				</div>
			</div>
			<div class="productNumber">
				...
				</span> <span>库存${product.stock}件</span>
			</div>
			<div class="serviceCommitment">
				<span class="serviceCommitmentDesc">服务承诺</span> <span
					class="serviceCommitmentLink"> <a href="#nowhere">七天无理由退换</a> <a
					href="#nowhere">十五天免费换货</a>
				</span>
			</div>
			<script>
                function buyLink() {
...
<div class="productDetailDiv" style="display: block;">
	...
	<div class="productDetailImagesPart">
		<img src="img/product/${product.id}/1.jpg">
	</div>
	<div class="productDetailImagesPart">
		<img src="img/product/${product.id}/2.jpg">
	</div>
	<div class="productDetailImagesPart">
		<img src="img/product/${product.id}/3.jpg">
	</div>
	<div class="productDetailImagesPart">
		<img src="img/product/${product.id}/4.jpg">
	</div>
	<div class="productDetailImagesPart">
		<img src="img/product/${product.id}/5.jpg">
	</div>
</div>
<div style="clear: both"></div>
	...
	<div class="productReviewTopPart">
		<div class="productReviewTopPart">
			...
			<a class="selected" href="#nowhere">累计评价 <span
				class="productReviewTopReviewLinkNumber">${product.reviewCount}</span>
			</a>
		</div>
