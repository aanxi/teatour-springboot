...
<div class="payedDiv">
	...
	<div class="payedAddressInfo">
		<ul>
			<li>收货信息：${o.address} ${o.receiver} ${o.mobile }</li>
			<li>实付款：<span class="payedInfoPrice"> ￥${param.total} </li>
			<li>预计3-5天送达</li>
		</ul>

		<div class="paedCheckLinkDiv">
			您可以 <a class="payedCheckLink" href="bought">查看已买到的宝贝</a>
		</div>
	...
	<div class="warningDiv">
		<img src="img/fore/warning.png"> <b>安全提醒：</b>下单后，<span>
			用QQ给您发送链接办理退款的都是骗子！</span>粤茶旅不存在系统升级，订单异常等问题，谨防假冒客服电话诈骗！
	</div>
