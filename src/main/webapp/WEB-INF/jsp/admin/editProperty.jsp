				...
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">
							分类管理 <small> - ${category.name} - id:${property.id} 属性值管理</small>
						</h1>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="panel panel-default">
							<div class="panel-heading">编辑属性名称</div>
								...
								<div class="row col-lg-12">
									<form action="updateProperty" role="form">
										<div class="form-group">
											...
											<label>属性名称：</label> <input name="name" class="form-control"
												value="${property.name}"> <br /> <input
