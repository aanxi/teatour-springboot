				...
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">
							分类管理 <small> - ${product.name} - 属性值管理</small>
						</h1>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">属性值管理表</div>
										...
										<tbody>
											<c:forEach items="${propertyValues}" var="pv">
												...
												<tr>
													...
													<td><a
														href="deletePropertyValue?id=${pv.id}&category_id=${product.category_id}"><span
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="panel panel-primary">
							<div class="panel-heading">增加属性值</div>
							<div class="panel-body">
								<form action="addPropertyValue" role="form"
									name="addPropertyValueForm">
									<input type="hidden" name="id" value=""> <input
										type="hidden" name="product_id" value="${product.id}">
									<label>属性名称：</label> <select class="form-control"
										onchange="document.addPropertyValueForm.property_id.value=this.value">
										<c:forEach var="p" items="${properties}">
											<option value="${p.id}">${p.name}</option>
										</c:forEach>
									</select> <input type="hidden" name="property_id" value=""> <label>属性值：</label>
									<input type="text" name="value" class="form-control"
										placeholder="请在这里输入属性值"><br> <input type="submit"
										class="btn btn-default pull-right" value="添加">
								</form>
							</div>
						</div>
					</div>
