			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a class="active-menu" href="listOrder"><i
							...
							<li><a class="active-menu" href="listAppointment">
<!-- 							<i class="fa fa-list-alt"></i> 预约管理</a></li> -->
										...
										<tbody>
											<c:forEach items="${orders}" var="o">
												<tr>
													...
													<td>${o.status}</td>
													<td>
														<%--<form action="updateOrder" role="form">--%> <%-- 表单隐藏信息 --%>
														<input type="hidden" name="id" value="${o.id}"> <input
														type="hidden" name="order_code" value="${o.order_code}">
														...
														value="${o.user_message}"> <input type="hidden"
														name="create_date" value="${o.create_date}"> <input
														type="hidden" name="pay_date" value="${o.pay_date}">
														<input type="hidden" name="delivery_date"
														value="${o.delivery_date}"> <input type="hidden"
														name="pay_date" value="${o.pay_date}"> <%-- 更改表单状态 --%>
														<c:if test="${o.status=='waitDelivery'}">
															<a href="orderDelivery?order_id=${o.id}">
																<button class="btn btn-primary btn-xs">发货</button>
															</a>
														</c:if> <%--<select name="status" class="form-control">--%> <%--<option>待付款</option>--%>
														<%--<option>已发货</option>--%> <%--<option>订单完成</option>--%>
