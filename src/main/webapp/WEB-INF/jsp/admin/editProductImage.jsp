				...
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">
							分类管理 <small> - ${product.name} - 图片管理</small>
						</h1>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-primary">
							<div class="panel-heading">产品图片编辑</div>
											...
											<tr>
												...
												<td class="col-md-5">
													<form action="updateProductImage" method="post"
														...
														<input type="hidden" name="id" value="${pi.id}"> <input
															type="hidden" name="product_id" value="${pi.product_id}">
												...
												<td><a
													href="deleteProductImage?product_id=${pi.product_id}&id=${pi.id}"><span
