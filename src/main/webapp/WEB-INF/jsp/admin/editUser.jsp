				...
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">
							用户管理 <small> - id:${user.id} 修改密码</small>
						</h1>
					</div>
				</div>
						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								<form action="updateUser" role="form">
									<input type="hidden" name="id" value="${user.id}"> <label>新密码：</label>
									<input class="form-control" type="text" name="password"
										placeholder="请在这里重新输入密码"><br> <input
										type="submit" class="btn btn-success pull-right" value="确认修改">
								</form>
