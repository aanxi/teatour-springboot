...
<div class="cartDiv">
			...
			<thead>
				<tr>
					<th class="selectAndImage"><img selectit="false"
						class="selectAllItem" src="img/fore/cartNotSelected.png"> 全选
			...
			<tbody>
				<c:forEach items="${orderItems}" var="oi">
					<tr orderItemId="${oi.id}" class="cartProductItemTR">
						<td><img selectit="false" orderItemId="${oi.id}"
							class="cartProductItemIfSelected"
							src="img/fore/cartNotSelected.png"> <a
							style="display: none" href="#nowhere"><img
								src="img/fore/cartSelected.png"></a> <img
							class="cartProductImg" src="img/product/${oi.product.id}/1.jpg">
						</td>
						<td>
						...
						<td><span class="cartProductItemOringalPrice">￥${oi.product.price}</span>
						...
						<td>
							...
							<div class="cartProductChangeNumberDiv">
								<span class="hidden orderItemStock "
									product_id="${oi.product.id}">${oi.product.stock}</span> <span
									class="hidden orderItemPromotePrice "
									product_id="${oi.product.id}">${oi.product.price}</span> <a
									product_id="${oi.product.id}" class="numberMinus"
									href="#nowhere">-</a> <input product_id="${oi.product.id}"
									orderItemId="${oi.id}" class="orderItemNumberSetting"
									autocomplete="off" value="${oi.number}"> <a
									stock="${oi.product.stock}" product_id="${oi.product.id}"
									class="numberPlus" href="#nowhere">+</a>
							</div>

						</td>
						<td><span class="cartProductItemSmallSumPrice"
							orderItemId="${oi.id}" product_id="${oi.product.id}">
								${oi.product.price*oi.number} </span></td>
						<td><a class="deleteOrderItem" orderItemId="${oi.id}"
	...
	<div class="cartFoot">
		<img selectit="false" class="selectAllItem"
			src="img/fore/cartNotSelected.png"> <span>全选</span>
		<!--         <a href="#">删除</a> -->
