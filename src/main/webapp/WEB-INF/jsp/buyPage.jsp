...
<div class="buyPageDiv">
	<form action="createOrder" method="post">
		...
		<div class="buyFlow">
			<img class="pull-left" src="img/logo.png"> <img
				class="pull-right" src="img/fore/buyflow.png">
			...
			<div>
				...
				<table class="addressTable">
					<tr>
						...
						<td><textarea name="address" placeholder="填写详细收货地址"></textarea></td>
					</tr>
					<tr>
						<td>邮政编码</td>
				...
				<thead>
					<tr>
						<th colspan="2" class="productListTableFirstColumn"> <a
							class="marketLink" href="#nowhere">店铺：粤茶旅</a> <a
					...
					<c:forEach items="${orderItems}" var="oi" varStatus="st">
						<tr class="orderItemTR">
							<td class="orderItemFirstTD"><img class="orderItemImg"
								src="img/product/${oi.product_id}/1.jpg"></td>
							<td class="orderItemProductInfo"><a
								href="showProduct?product_id=${oi.product_id}"
							...
							<td>
								...
								<%--minFractionDigits="2"/>--%> <%--</span>--%> <span>${oi.product.price*oi.number}</span>
							</td>
			...
			<div class="orderItemSumDiv">
				<div class="pull-left">
					<span class="leaveMessageText">给卖家留言:</span> <span> <img
						class="leaveMessageImg" src="img/fore/leaveMessage.png">
